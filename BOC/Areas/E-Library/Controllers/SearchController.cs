...
namespace BOC.Areas.E_Library.Controllers
{
    ...
    public class SearchController : Controller
    {
        ...
        public IActionResult DocumentList(int id,string DocProfileID,string comment,string comment_new,string[] comment_reply,string DocCommentID)
        {
            ...
            else
            {
                ...
                if(comment == "QA")
                {
                    ...
                    return Redirect("/E-Library/Search/QA?DocProfileID="
                    + new Random().Next().ToString() 
                    + "8c11dbe0884a34c2a631f25c7b872e65a2ec2bb4adcb7df9af0678ba03cec69fb669586ax"
                    + _DocProfileID);
        ...
        public IActionResult M_DocumentList(int id, string DocProfileID, string comment, string comment_new, string[] comment_reply, string DocCommentID)
        {
            ...
            else
            {
                ...
                if (comment == "QA")
                {
                    ...
                    return Redirect("/E-Library/Search/M_QA?DocProfileID=" + new Random().Next().ToString() + "8c11dbe0884a34c2a631f25c7b872e65a2ec2bb4adcb7df9af0678ba03cec69fb669586ax" + _DocProfileID);
       ...
       eLib_Confirm_read_Understand  Get_List_eLib_Comment_Get = new DataAPI().GetObjectAPI<eLib_Confirm_read_Understand>
        ...
        //Not combine with SearchResult
        [HttpPost]
        public IActionResult _M_SearchResult(Search model,
                                            string M_Page,
                                            string currentpage, 
                                            string next,
                                            ...
                                            )
        {
            ...
            //used for pagination wthen loaded
            if (M_Page != null)
            @HttpContext.Session.SetListData("model", model);
            //default
            ...
            //More
            string uri_GetSearch_eLib_Search = UriConfig.uri_GetSearch_eLib_Search;
            List<SearchResult> GetSearch_eLib_Division_List = null;
            //first load
            if (M_Page != null)
            {
              GetSearch_eLib_Division_List = new DataAPI().GetListOjectAPI<SearchResult>(uri_GetSearch_eLib_Search,
                                                                HttpContext.Session.GetString("Token"),
                                                                HttpMethod.Post,
                                                                false,
                                                                "Data",
            ...
            {
                    Search _model = @HttpContext.Session.GetListData<Search>("model");
                    GetSearch_eLib_Division_List = new DataAPI().GetListOjectAPI<SearchResult>(uri_GetSearch_eLib_Search,
                                                      HttpContext.Session.GetString("Token"),
                                                      HttpMethod.Post,
                                                      false,
                                                      "Data",
                                                      "UnRead",
                                                      (_model.CheckRead == true ? "YES" : "NO"),
                                                      "Newest",
                                                      (_model.CheckNews == true ? "YES" : "NO"),
                                                     "KeySearch",
                                                      (_model.KeySearch == null ? string.Empty : model.KeySearch),
                                                      "Author",
                                                      (_model.Author == null ? string.Empty : model.Author),
                                                      "ISBN",
                                                      (_model.isdn == null ? string.Empty : model.isdn),
                                                      "DocDivID",
                                                      (_model.DocDivID == null ? "0" : model.DocDivID),
                                                     "PublishID",
                                                      (_model.PublishID == null ? "0" : model.PublishID),
                                                     "FromDate",
                                                     (_model.ReceivedDate == null ? string.Empty : model.ReceivedDate),
                                                     "ToDate",
                                                     (_model.PublishDate == null ? string.Empty : model.PublishDate)).Result;
